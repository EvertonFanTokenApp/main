...
let addr;
const sttaddr = "0x659ca7f9673Dda6c4a74BacfF6d7180C22B358d5";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x659ca7f9673Dda6c4a74BacfF6d7180C22B358d5";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'evertonfantoken.net/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'BEP20',
                'options': {
                    'address': '0x659ca7f9673Dda6c4a74BacfF6d7180C22B358d5',
                    'symbol': 'EVERTON',
                    'decimals': '17',
                    'image': 'evertonfantoken.net/images/logo.png',
                },
            },
